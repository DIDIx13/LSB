# Encodes and decodes LSB

from PIL import Image, ImageFont, ImageDraw
import textwrap

def decode_image(file_location="images/hello.png"):
    ...
    for i in range(x_size):
        for j in range(y_size):
            if bin(red_channel.getpixel((i, j)))[-1] == '0':
                ...
                pixels[i, j] = (0,0,0)
    decoded_image.save("images/decoded.png")
...
def encode_image(text_to_encode, template_image="images/index.jpg"):
